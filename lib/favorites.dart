                                ...
                                children: <Widget>[
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                           ...
                                           Container(
                                            width: 50,
                                            decoration: BoxDecoration(
                                              color: FavoritesData[index]["couleur"],
                                              borderRadius:
                                  ...
                                  Padding(
                                    ...
                                    child:Row(
                                      children: [
                                    Text(
                                     "Color: " +""+ FavoritesData[index]["color"],
                                      style: TextStyle(
                                          fontSize: 9,
                                          fontFamily: 'poppin',
                                  ...
                                  Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(FavoritesData[index]["ancienprix"],
                                              style: TextStyle(
                                                fontFamily: 'poppin',
                                                fontSize: 13,
                                                color: Colors.grey,
                                          ...
                                          Text(FavoritesData[index]["nouvprix"],
                                              style: TextStyle(
                                                  fontFamily: 'poppin',
                                                  fontSize: 13,
