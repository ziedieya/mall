...
class Bagkiko4 extends StatefulWidget {
  const Bagkiko4({Key? key}) : super(key: key);

  @override
  State<Bagkiko4> createState() => _Bagkiko4State();
}

class _Bagkiko4State extends State<Bagkiko4> {

  int counter = 0;
  double articlePrice = 100.0; // Prix initial de l'article
  double totalPrice = 0;

  void incrementCounter() {
    setState(() {
      counter++;
      articlePrice = 100.0 * counter;
      calculateTotalPrice();
    });
  }
