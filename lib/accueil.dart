                    ...
                    child: Container(
                       ...
                       child:Align(
                        ...
                        child:Text('New',style: TextStyle(fontFamily: 'poppin',fontSize: 12,color: Colors.white),),
                            ...
                            ListTile(
                              title:Text("Blouse large",style: TextStyle(fontFamily: 'poppin',fontSize: 15,color: Colors.black),),
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                children: [
                                  ...
                                  Text('190DT',style: TextStyle(fontFamily: 'poppin',fontSize: 13,color: Color.fromARGB(255, 230, 100, 91))),
                               Container(
                                     width: 29,
                                     height: 29,
...
Container(
  ...
  padding: const EdgeInsets.all(20),
    decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
                          ...
                          image: DecorationImage(
                              image: AssetImage("assets/images/pull h&m.jpg" ),
                              fit:BoxFit.cover,
                      ),
 ...
 Padding(padding: const EdgeInsets.fromLTRB(10,10,0,0),
                    child:  Container(
                        ...
                        child:Text('New',style: TextStyle(fontFamily: 'poppin',fontSize: 12,color: Colors.white),),
                            ...
                            ListTile(
                              title:Text("pull large",style: TextStyle(fontFamily: 'poppin',fontSize: 15,color: Colors.black),),
                              subtitle: Text("Dorothy perkins",style: TextStyle(fontSize: 9,fontFamily: 'poppin',color: Colors.grey),),
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                children: [
                                  //IconButton(onPressed: (){},icon: const Icon(Icons.add_a_photo_rounded))
                                  Text('200DT',style: TextStyle(fontFamily: 'poppin',fontSize: 13,color: Color.fromARGB(255, 230, 100, 91))),
                                  Container(
                                     width: 29,
                                     height: 29,
...
Container(
  ...
  padding: const EdgeInsets.all(20),
    decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
                          ...
                          image: DecorationImage(
                              image: AssetImage("assets/images/chemise oxford oversize.jpg" ),
                              fit:BoxFit.cover,
                      ),
                    ...
                    child:  Container(
                        ...
                        child:Text('New',style: TextStyle(fontFamily: 'poppin',fontSize: 12,color: Colors.white),),
                            ...
                            ListTile(
                              title:Text("chemise courte",style: TextStyle(fontFamily: 'poppin',fontSize: 15,color: Colors.black),),
                              subtitle: Text("Dorothy perkins",style: TextStyle(fontSize: 9,fontFamily: 'poppin',color: Colors.grey),),
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                children: [
                                  //IconButton(onPressed: (){},icon: const Icon(Icons.add_a_photo_rounded))
                                  Text('125DT',style: TextStyle(fontFamily: 'poppin',fontSize: 13,color: Color.fromARGB(255, 230, 100, 91))),
 Container(
                                     width: 29,
                                     height: 29,
