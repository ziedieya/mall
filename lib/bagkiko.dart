...
class Bagkiko extends StatefulWidget {
  const Bagkiko({Key? key}) : super(key: key);

  @override
  State<Bagkiko> createState() => _BagkikoState();
}

class _BagkikoState extends State<Bagkiko> {

  int counter = 0;
  double articlePrice = 50.0; // Prix initial de l'article
  double totalPrice = 0;

  void incrementCounter() {
    setState(() {
      counter++;
      articlePrice = 50.0 * counter;
      calculateTotalPrice();
    });
  }
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage("assets/images/glose1.jpg"),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
