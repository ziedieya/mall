...
import 'package:firstapp/bag1.dart';
...
class Bag2 extends StatefulWidget {
  const Bag2({ Key? key }) : super(key: key);

  @override
  State<Bag2> createState() => _Bag2State();
}

class _Bag2State extends State<Bag2> {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage("assets/images/surchemise en twill.jpg"),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
