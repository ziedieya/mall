...
class Bagkiko1 extends StatefulWidget {
  const Bagkiko1({Key? key}) : super(key: key);

  @override
  State<Bagkiko1> createState() => _Bagkiko1State();
}

class _Bagkiko1State extends State<Bagkiko1> {

  int counter = 0;
  double articlePrice = 45.0; // Prix initial de l'article
  double totalPrice = 0;

  void incrementCounter() {
    setState(() {
      counter++;
      articlePrice = 45.0 * counter;
      calculateTotalPrice();
    });
  }
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage("assets/images/mat2.jpg"),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
