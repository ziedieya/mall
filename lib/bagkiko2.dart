...
class Bagkiko2 extends StatefulWidget {
  const Bagkiko2({Key? key}) : super(key: key);

  @override
  State<Bagkiko2> createState() => _Bagkiko2State();
}

class _Bagkiko2State extends State<Bagkiko2> {

  int counter = 0;
  double articlePrice = 39.0; // Prix initial de l'article
  double totalPrice = 0;

  void incrementCounter() {
    setState(() {
      counter++;
      articlePrice = 39.0 * counter;
      calculateTotalPrice();
    });
  }
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage("assets/images/glose3.jpg"),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
